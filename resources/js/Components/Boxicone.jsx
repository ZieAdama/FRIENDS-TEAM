    ...
    <div className="row">
      <div className="col-12 col-sm-6 col-md-3">
        <div className="info-box">
          <span className="info-box-icon elevation-1 bg-secondary"><i className="fas fa-cog"></i></span>
      ...
      <div className="col-12 col-sm-6 col-md-3">
        <div className="info-box mb-3">
          <span className="info-box-icon elevation-1 bg-secondary"><i className="fas fa-thumbs-up"></i></span>
      ...
      <div className="col-12 col-sm-6 col-md-3">
        <div className="info-box mb-3">
          <span className="info-box-icon elevation-1 bg-secondary"><i className="fas fa-shopping-cart"></i></span>
      ...
      <div className="col-12 col-sm-6 col-md-3">
        <div className="info-box mb-3">
          <span className="info-box-icon elevation-1 bg-secondary"><i className="fas fa-users"></i></span>
